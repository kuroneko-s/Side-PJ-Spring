...
public class ProfessionalAccountRepositoryExtensionImpl extends QuerydslRepositorySupport implements ProfessionalAccountRepositoryExtension {
    public ProfessionalAccountRepositoryExtensionImpl() {
