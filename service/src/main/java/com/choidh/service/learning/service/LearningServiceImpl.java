...
public class LearningServiceImpl implements LearningService {
    ...
    public List<Learning> learningOrderByCreateLearning() {
        return learningRepository.findTop4ByOpeningOrderByOpeningDateDesc(true);
    }

    @Override
    public List<Learning> learningOrderByRating() {
        return learningRepository.findTop12ByOpeningOrderByRatingDesc(true);
    }
    ...
    public Learning getLearningByIdWithQuestion(Long learningId) {
        return learningRepository.findLearningByLearningIdWithQuestion(learningId);
    }
