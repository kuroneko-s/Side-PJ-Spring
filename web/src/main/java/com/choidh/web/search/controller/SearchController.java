...
public class SearchController {
    ...
    public String viewAll(@CurrentAccount Account account, Model model,
        ...
        Page<Learning> pageableLearning = learningRepository.findAllWithPageable(pageable);
    ...
    public String viewWebAll(@CurrentAccount Account account, Model model,
        ...
        Page<Learning> pageableLearning = learningRepository.findByCategoryWithPageable("web" , pageable);
    ...
    public String viewWebJava(@CurrentAccount Account account, Model model, String keyword,
        ...
        Page<Learning> pageableLearning = learningRepository.findByCategoryAndKeywordWithPageable(keyword, "web" , pageable);
    ...
    public String viewAlgorithmAll(@CurrentAccount Account account, Model model,
        ...
        Page<Learning> pageableLearning = learningRepository.findByCategoryWithPageable("algorithm" , pageable);
    ...
    public String viewAlgorithmGOF(@CurrentAccount Account account, Model model, String keyword,
        ...
        Page<Learning> pageableLearning = learningRepository.findByCategoryAndKeywordWithPageable(keyword,"algorithm" , pageable);
